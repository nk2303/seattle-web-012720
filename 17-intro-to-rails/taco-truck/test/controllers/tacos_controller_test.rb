...
class TacosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create taco" do
    assert_difference('Taco.count') do
      post tacos_url, params: { taco: { meat: @taco.meat, spicy: @taco.spicy, weight: @taco.weight, zest: @taco.zest } }
    end
  ...
  test "should update taco" do
    patch taco_url(@taco), params: { taco: { meat: @taco.meat, spicy: @taco.spicy, weight: @taco.weight, zest: @taco.zest } }
